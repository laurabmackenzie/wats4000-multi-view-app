<template>
  <div class="survey">
      ...
      <form v-on:submit.prevent="validateForm"> <!--handles the form submission. -->
      <p class="error" v-show="showError">Some of the data has been entered incorrectly or is incomplete. Please try again</p><!--displays an error message for when the user submits invalid information.-->
